<%@ Page Title="" Language="C#" MasterPageFile="~/Config.Master" AutoEventWireup="true" CodeBehind="AreaManagerFix.aspx.cs" Inherits="Denion.WebService.Beheer.AreaManagerFix" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="grd" runat="server"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="AreaManagerIdFrom">
                <ItemTemplate>
                    <center>
                        <asp:Label ID="AreaManagerIdFrom" Text='<%# Bind("AreaManagerIdFrom") %>' runat="server"></asp:Label></center>
                </ItemTemplate>
                <EditItemTemplate>
                    <center>
                        <asp:TextBox ID="AreaManagerIdFrom" Text='<%# Bind("AreaManagerIdFrom") %>' runat="server"></asp:TextBox></center>
                </EditItemTemplate>
                <FooterTemplate>
                    <center>
                        <asp:TextBox ID="AreaManagerIdFrom" runat="server"></asp:TextBox></center>
                </FooterTemplate>
                <ControlStyle Width="95%" />
            </asp:TemplateField>

            <asp:TemplateField HeaderText="AreaManagerIdTo">
                <ItemTemplate>
                    <center>
                        <asp:Label ID="AreaManagerIdTo" Text='<%# Bind("AreaManagerIdTo") %>' runat="server"></asp:Label></center>
                </ItemTemplate>
                <EditItemTemplate>
                    <center>
                        <asp:TextBox ID="AreaManagerIdTo" Text='<%# Bind("AreaManagerIdTo") %>' runat="server"></asp:TextBox></center>
                </EditItemTemplate>
                <FooterTemplate>
                    <center>
                        <asp:TextBox ID="AreaManagerIdTo" runat="server"></asp:TextBox></center>
                </FooterTemplate>
                <ControlStyle Width="95%" />
            </asp:TemplateField>
