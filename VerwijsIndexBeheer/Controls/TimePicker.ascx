<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TimePicker.ascx.cs" Inherits="Denion.WebService.Beheer.Controls.TimePicker" %>
...
<asp:Panel ID="Panel1" runat="server" Width="200px">
    ...
    <ajt:calendarextender ID="calDate" runat="server" TargetControlID="txtDate" Format="dd-MM-yyyy" />
