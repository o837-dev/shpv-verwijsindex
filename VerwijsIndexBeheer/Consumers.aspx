<%@ Page Language="C#" MasterPageFile="~/Config.Master" AutoEventWireup="true" CodeBehind="Consumers.aspx.cs" Inherits="Denion.WebService.Beheer.Consumers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="grd" runat="server"
        ...
        onrowupdating="grd_RowUpdating" DataKeyNames="CID"
        AutoGenerateColumns="False" onrowdeleting="grd_RowDeleting" 
        OnRowCommand="grd_RowCommand" ShowFooter="true" 
        onrowdatabound="grd_RowDataBound">
        <Columns>
            <asp:BoundField DataField="CID" Visible="false" HeaderText="PID" />

            <asp:TemplateField HeaderText="ID">
                <ItemTemplate>
                    <center><asp:Label ID="ConsumerID" Text='<%# Bind("ID") %>' runat="server"></asp:Label></center>
                    </ItemTemplate>
                <EditItemTemplate>
                    <center><asp:TextBox ID="ConsumerID" Text='<%# Bind("ID") %>' runat="server"></asp:TextBox></center>
                </EditItemTemplate>
                <FooterTemplate>
                    <center><asp:TextBox ID="ConsumerID" runat="server"></asp:TextBox></center>
                </FooterTemplate>
            ...
            <asp:TemplateField HeaderText="URL">
                <ItemTemplate>
                    <center><asp:Label ID="ConsumerURL" Text='<%# Bind("URL") %>' runat="server"></asp:Label></center>
                    </ItemTemplate>
                <EditItemTemplate>
                    <center><asp:TextBox ID="ConsumerURL" Text='<%# Bind("URL") %>' runat="server"></asp:TextBox></center>
                </EditItemTemplate>
                <FooterTemplate>
                    <center><asp:TextBox ID="ConsumerURL" runat="server"></asp:TextBox></center>
                </FooterTemplate>
                <ControlStyle Width="95%" />
             </asp:TemplateField>
             ...
             <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    ...
                    OnClientClick="if(!confirm('Weet U zeker dat U deze Consumer wilt verwijderen?')) return false;" ></asp:LinkButton>
                </ItemTemplate>
                <EditItemTemplate>
