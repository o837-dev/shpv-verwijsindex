...
namespace Denion.WebService.Beheer
{
    public partial class Types : System.Web.UI.Page
    {
        ...
        {
            lblTable.Text = "Types";
            DataTable dt = Database.Database.ShowTable("Types");
        ...
        protected void grd_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            SqlCommand com = new SqlCommand("update [TYPES] set TYPE=@TYPE where ID=@OLDID");
        ...
        {
            SqlCommand com = new SqlCommand("delete from [TYPES] where [ID]=@ID");
        ...
        protected void grd_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Insert")
            {
                ...
                SqlCommand com = new SqlCommand("INSERT INTO [TYPES] (TYPE) values (@TYPE)");
                ArgumentsFromDictionary(com, dic);
